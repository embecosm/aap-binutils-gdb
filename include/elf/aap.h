...
START_RELOC_NUMBERS (elf_aap_reloc_type)
  ...
  RELOC_NUMBER (R_AAP_ABS3_SHORT,   11)
  RELOC_NUMBER (R_AAP_OFF3_SHORT,   12)
  RELOC_NUMBER (R_AAP_ABS6_SHORT,   13)
  RELOC_NUMBER (R_AAP_ABS6,         14)
  RELOC_NUMBER (R_AAP_ABS9,         15)
  RELOC_NUMBER (R_AAP_ABS10,        16)
  RELOC_NUMBER (R_AAP_OFF10,        17)
  RELOC_NUMBER (R_AAP_ABS12,        18)
  RELOC_NUMBER (R_AAP_ABS16,        19)
