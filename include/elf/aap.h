...
START_RELOC_NUMBERS (elf_aap_reloc_type)
  ...
  RELOC_NUMBER (R_AAP_ABS6_SHORT,   12)
  RELOC_NUMBER (R_AAP_ABS6,         13)
  RELOC_NUMBER (R_AAP_ABS9,         14)
  RELOC_NUMBER (R_AAP_ABS10,        15)
  RELOC_NUMBER (R_AAP_OFF10,        16)
  RELOC_NUMBER (R_AAP_ABS12,        17)
  RELOC_NUMBER (R_AAP_ABS16,        18)
