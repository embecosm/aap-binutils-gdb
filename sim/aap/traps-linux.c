  ...
  if (STATE_ENVIRONMENT (sd) == OPERATING_ENVIRONMENT)
    {
      ...
      if (MACH_NUM (CPU_MACH (current_cpu)) == MACH-32)
        {
...
aap_trap (SIM_CPU *current_cpu, PCADDR pc, int num)
{
  ...
  switch (num)
	...
	func = aapbf_h_gr_get (current_cpu, 7);
	arg1 = aapbf_h_gr_get (current_cpu, 0);
	arg2 = aapbf_h_gr_get (current_cpu, 1);
	arg3 = aapbf_h_gr_get (current_cpu, 2);
	arg4 = aapbf_h_gr_get (current_cpu, 3);
	arg5 = aapbf_h_gr_get (current_cpu, 4);
	arg6 = aapbf_h_gr_get (current_cpu, 5);
	arg7 = aapbf_h_gr_get (current_cpu, 6);
        ...
        if (result == -1)
	  aapbf_h_gr_set (current_cpu, 0, -errcode);
        else
	  aapbf_h_gr_set (current_cpu, 0, result);
	break;
      }
