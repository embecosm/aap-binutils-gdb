...
const char *
aap_cgen_parse_operand (CGEN_CPU_DESC cd,
			   int opindex,
			   const char ** strp,
			   CGEN_FIELDS * fields)
{
  ...
  switch (opindex)
    ...
    case AAP_OPERAND_UINT3 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, AAP_OPERAND_UINT3, (unsigned long *) (& fields->f_uint_2_3));
      break;
    case AAP_OPERAND_UINT6 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, AAP_OPERAND_UINT6, (unsigned long *) (& fields->f_uint_5_6));
      break;
    case AAP_OPERAND_XDEST :
      errmsg = cgen_parse_keyword (cd, strp, & aap_cgen_opval_gr_names, & fields->f_long_dst_reg);
      break;
    case AAP_OPERAND_XSRC1 :
      errmsg = cgen_parse_keyword (cd, strp, & aap_cgen_opval_gr_names, & fields->f_long_src_reg_1);
      break;
    case AAP_OPERAND_XSRC2 :
      errmsg = cgen_parse_keyword (cd, strp, & aap_cgen_opval_gr_names, & fields->f_long_src_reg_2);
      break;
...
cgen_parse_fn * const aap_cgen_parse_handlers[] = 
{
  parse_insn_normal,
};

void
aap_cgen_init_asm (CGEN_CPU_DESC cd)
{
  aap_cgen_init_opcode_table (cd);
  aap_cgen_init_ibld_table (cd);
  cd->parse_handlers = & aap_cgen_parse_handlers[0];
  cd->parse_operand = aap_cgen_parse_operand;
...
/* Regex construction routine.
   ...
   later use by aap_cgen_assemble_insn

   Returns NULL for success, an error message for failure.  */

char * 
aap_cgen_build_insn_regex (CGEN_INSN *insn)
{  
...
const CGEN_INSN *
aap_cgen_assemble_insn (CGEN_CPU_DESC cd,
			   const char *str,
			   CGEN_FIELDS *fields,
  ...
  for ( ; ilist != NULL ; ilist = CGEN_ASM_NEXT_INSN (ilist))
    {
	 ...
	 shouldn't be in the hash lists.  */
      ...
      if (! aap_cgen_insn_supported (cd, insn))
	continue;
#endif
